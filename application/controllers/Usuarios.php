...
class Usuarios extends MY_Controller
{
    ...
    public function adicionar()
    {
        ...
        // Limpar qualquer regra existente
        $this->form_validation->reset_validation();
        
        // Definir apenas as regras necessárias
        ...
        $this->form_validation->set_rules('idUnidadeSolicitante', 'Unidade Solicitante', 'trim');

        // Campos opcionais - apenas trim, sem required
        $this->form_validation->set_rules('cns', 'CNS', 'trim');
        $this->form_validation->set_rules('conselho', 'Conselho', 'trim');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                ...
                'idUnidadeSolicitante' => $this->input->post('idUnidadeSolicitante'),
        ...
        $this->data['unidades_solicitantes'] = $this->usuarios_model->getAllUnidadesSolicitantes();
    ...
    public function editar()
    {
        ...
        $this->form_validation->set_rules('telefone', 'Telefone', 'trim');
        $this->form_validation->set_rules('celular', 'Celular', 'trim');
        $this->form_validation->set_rules('senha', 'Senha', 'trim'); // senha é opcional na edição
        $this->form_validation->set_rules('dataExpiracao', 'Data de Expiração', 'trim');
