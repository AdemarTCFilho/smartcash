  ...
  <div id="content-header">
   <div></div>
    ...
    <div class="container-flu">
      <div class="row-fluid">
        <div class="span12">
          <?php if ($var = $this->session->flashdata('success')): ?><script>swal("Sucesso!", "<?php echo str_replace('"', '', $var); ?>", "success");</script><?php $this->session->set_flashdata('success', ''); ?><?php endif; ?>
          <?php if ($var = $this->session->flashdata('error')): ?><script>swal("Falha!", "<?php echo str_replace('"', '', $var); ?>", "error");</script><?php $this->session->set_flashdata('error', ''); ?><?php endif; ?>
          <?php if (isset($view)) {
