            ...
            <div id="userMC">
                ...
                <div class="control-group" style="margin-bottom: 5px">
                    <label for="user" class="">
                        <span class="">
                            <a href="#modalImageUser" data-toggle="modal" role="button" class="button btn btn-mini btn-success" style="max-width: 200px">
                ...
                <div class="span12" style="min-height: 260px">
                    <form id="formSenha" action="<?= site_url('mapos/alterarSenha'); ?>" method="post">
                        ...
                        <div class="span12" style="margin-left: 0">
                            ...
                            <button class="button btn btn-primary" style="max-width: 200px;text-align: center">
