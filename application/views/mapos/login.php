...
<div id="loginbox">
  ...
  <div class="d-flex flex-column">
      <div class="right-login">
        <div class="container">
          <div class="card" style="background: #201e52 !important;">
            <div class="content">
              <div id="newlog">
                <!-- <div class="icon2">
                ...
                <div class="title01">
                  <?php if (isset($configuration['app_theme']) && $configuration['app_theme'] == 'white') : ?>
                      <img src="<?= base_url('assets/img/smart-cash-logo.png') ?>">
                  <?php else : ?>
                      <img src="<?= base_url('assets/img/smart-cash-logo.png') ?>">
                  <?php endif; ?>
              </div>
              ...
              <div class="center"><button id="btn-acessar"><b>Acessar</b></button>
              </div>
              <div class="links-uteis"><a href="#"><p><?= date('Y'); ?> &copy; v0.1 — Executive</p></a>
              </div>
